...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "INSERT INTO ajc_transaksi(no_nota, jenis, nama, bayar, kembali, total, tanggal, id_user) VALUES('$no_nota', '$jenis', '$nama', '$bayar', '$kembali', '$total', NOW(), '$id_user')");
...
<form method="post" action="" class="form-horizontal" role="form">
	<div class="form-group">
		...
		<?php
			...
			$sql = mysqli_query($koneksi, "SELECT no_nota FROM ajc_transaksi");
