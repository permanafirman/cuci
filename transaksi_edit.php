...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "UPDATE ajc_transaksi SET jenis='$jenis', nama='$nama', bayar='$bayar', kembali='$kembali', total='$total', tanggal=NOW(), id_user='$id_user' WHERE id_transaksi='$id_transaksi'");
		...
		$sql = mysqli_query($koneksi, "SELECT * FROM ajc_transaksi WHERE id_transaksi='$id_transaksi'");
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			...
			<?php
				...
				$q = mysqli_query($koneksi, "SELECT jenis FROM ajc_biaya");
