...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "UPDATE ajc_biaya SET jenis='$jenis', biaya='$biaya' WHERE id_biaya='$id_biaya'");
		...
		$sql = mysqli_query($koneksi, "SELECT * FROM ajc_biaya WHERE id_biaya='$id_biaya'");
